          ...
          <el-form-item class="input" label="商品价格" prop="shangpinjiage">
              <el-input v-model="ruleForm.shangpinjiage" 
                placeholder="商品价格" readonly></el-input>
                                                                                              ...
                                                                                              <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="商品功能" prop="shangpingongneng">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="商品功能"
                  v-model="ruleForm.shangpingongneng" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shangpingongneng" label="商品功能" prop="shangpingongneng">
                    <span>{{ruleForm.shangpingongneng}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `lvyoushangpin/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.lvyoushangpinCrossAddOrUpdateFlag = false;
                  this.parent.search();
