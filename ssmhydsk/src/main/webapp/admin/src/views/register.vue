  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.26);borderRadius:10px">
        <h1 class="h1" style="color:rgba(255, 255, 255, 1);fontSize:28px;">旅游出行必备商城小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="用户手机" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.yonghushouji" autocomplete="off" placeholder="用户手机" type="text" />
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.songhuodizhi" class="input" type="text" placeholder="送货地址">
			   </div>
			 </div> -->
			<el-form-item label="送货地址" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.songhuodizhi" autocomplete="off" placeholder="送货地址" type="text" />
			</el-form-item>
